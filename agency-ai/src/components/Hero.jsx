  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className='bg-gradient-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent mr-3'>
          digital
        </span>
      ...
      >
        Creating meaningful connections and turning big ideas into interactive digital experience.
      </motion.p>
